...
$row = $results->fetch();
        ...
        else
        {
            ...
            while($row != false)
            {
                ...
                echo "<a href='javascript:void(null);' onclick='rfb(".$row["ID"].")'>Remove from basket</a><br>"; // refreshs search results after 1s, I imagine this is bad practice but it works
                echo "----------------------------"; 
